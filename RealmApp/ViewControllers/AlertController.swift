...
extension UIAlertController {
    ...
    static func createAlert(withTitle title: String, andMesage message: String) -> UIAlertController {
        UIAlertController(title: title, message: message, preferredStyle: .alert)
    }
    
    func action(with taskList: TaskList?, completion: @escaping (String) -> Void) {
        
        let doneButtone = taskList == nil ? "Save" : "Update"
        
        let saveAction = UIAlertAction(title: doneButtone, style: .default) { _ in
